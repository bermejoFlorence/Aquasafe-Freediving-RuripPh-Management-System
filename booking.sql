...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 22, 2025 at 12:16 PM
...
--
ALTER TABLE `booking`
  ADD CONSTRAINT `fk_booking_package` FOREIGN KEY (`package_id`) REFERENCES `package` (`package_id`) ON DELETE SET NULL ON UPDATE CASCADE,
